...
class UserState:
    ...
    @staticmethod
    def authenticate(access_token: str, refresh_token: str, user_info: auth_schema.UserInfo) -> None:
    ...
    def user_info(self) -> auth_schema.UserInfo | None:
        return st.session_state.get('user_info') if st.session_state.get('user_info') else None
    ...
    def current_session(self) -> session_schema.SessionRead:
        return st.session_state.get("current_session") if st.session_state.get("current_session") else None
    ...
    def sessions(self) -> List[session_schema.SessionRead]:
        return st.session_state.get("sessions") if st.session_state.get("sessions") else []
    ...
    def available_models(self) -> List:
        return st.session_state.get("available_models") if st.session_state.get("available_models") else []
