...
class TestAuthService:
    ...
    def test_register_success(self, auth_service, mock_auth_repository, user_create_request):
    ...
    def test_register_with_repository_exception(self, auth_service, mock_auth_repository, user_create_request):
    ...
    def test_register_with_auth_error(self, auth_service, mock_auth_repository, user_create_request):
    ...
    def test_login_success(self, auth_service, mock_auth_repository, login_request):
        ...
        mock_auth_repository.authenticate.return_value = mock_session
    ...
    def test_login_with_invalid_credentials(self, auth_service, mock_auth_repository, login_request):
        ...
        assert "邮箱或密码错误" in str(exc_info.value.message)

    def test_login_with_repository_exception(self, auth_service, mock_auth_repository, login_request):
    ...
    def test_get_current_user_success(self, auth_service, mock_auth_repository):
        ...
        # Verify repository was called
        mock_auth_repository.get_user_by_token.assert_called_once_with("valid-token-123")
    ...
    def test_get_current_user_with_invalid_token(self, auth_service, mock_auth_repository):
    ...
    def test_get_current_user_with_repository_exception(self, auth_service, mock_auth_repository):
    ...
    def test_register_logs_exception(self, mock_logger, auth_service, mock_auth_repository, user_create_request):
    ...
    @patch('src.backend.app.services.auth.logger')
    def test_login_logs_exception(self, mock_logger, auth_service, mock_auth_repository, login_request):
    ...
    @patch('src.backend.app.services.auth.logger')
    def test_get_current_user_logs_exception(self, mock_logger, auth_service, mock_auth_repository):
    ...
    def test_register_with_different_email(self, auth_service, user_create_request):
        ...
        mock_repo = Mock()
        mock_repo.create_user = Mock(return_value={
            "id": 456,
    ...
    def test_login_with_different_email(self, auth_service, mock_auth_repository, login_request):
    ...
    def test_login_returns_token_type_bearer(self, auth_service, mock_auth_repository, login_request):
    ...
    def test_register_with_empty_optional_fields(self, auth_service, user_create_request):
